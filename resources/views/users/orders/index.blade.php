...
" />
           ...
           <div class="mb-3">
            ...
            <input type="text" class="form-control" id="address" value="{{ Auth::user()->contact_address ?? '' }}
" required="" />
            <div class="invalid-feedback">
           ...
           <div class="mb-3">
            <label for="address2">Address 2
             <span class="text-muted">(Optional)</span></label>
            <input type="text" class="form-control" id="address2" value="{{ Auth::user()->permanent_address ?? '' }}
" />
           </div>
           ...
           <div class="row">
            ...
            <div class="col-md-3 mb-3">
             ...
             <input type="text" class="form-control" id="zip" value="{{ Auth::user()->zip_code ?? '' }}
" required="" />
             <div class="invalid-feedback">
              Zip code required.
             </div>
           ...
           <form class="needs-validation" novalidate="" action="{{ route('orders.store') }}" method="post"
            ...
            <div class="d-block my-2">
             ...
             <div class="custom-control custom-radio">
              <input id="paypal" name="paymentmethod" value="Paypal card" type="radio" class="custom-control-input"
               required="" />
            ...
            <div class="row">
             <div class="col-md-6 mb-3">
              ...
              <input type="text" class="form-control" name="card_name" id="cc-name" placeholder="" required="" />
             ...
             <div class="col-md-6 mb-3">
              ...
              <input type="text" class="form-control" name="card_no" id="cc-number" placeholder="" required="" />
              <div class="invalid-feedback">
            ...
            <div class="row">
             <div class="col-md-3 mb-3">
              ...
              <input type="date" class="form-control" name="exp_date" id="cc-expiration" placeholder="" required="" />
              <div class="invalid-feedback">
             ...
             @php $total += $cartItem['product_price'] * $cartItem['product_quantity'] @endphp
             <!-- user id -->
             <input type="hidden" name="user_id" value="{{ Auth::user()->id }}">
             <input type="hidden" name="product_id[]" value="{{ $cartItem['product_id'] }}">
             <!-- product image -->
             <input type="hidden" name="product_image[]" value="{{ $cartItem['product_image'] }}">
            ...
            <input type="submit" class="btn btn-info btn-lg" value="Continue to checkout">
